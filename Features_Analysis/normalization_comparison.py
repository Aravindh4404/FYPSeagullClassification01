...
def compute_region_global_minmax(image_list, region_name):
    """
...
def run_region_normalization_comparison(region_name="wingtip"):
    ...
    global_min, global_max = compute_region_global_minmax(all_images, region_name)
...
if __name__ == "__main__":
    # Run the comparison for the wingtip region
    # run_region_normalization_comparison("wingtip")
    #
    # # Uncomment to run for other regions
    # # run_region_normalization_comparison("wing")
    # # run_region_normalization_comparison("head")
    # # run_region_normalization_comparison("body")
    run_region_normalization_comparison("entire_bird")