...
def generate_gradcam_and_confusion_matrix(model_path, data_dir, output_dir):
    ...
    # Setup Grad-CAM
    # For ResNet50, we use the final convolutional layer (layer4)
    ...
    cm_output_path = os.path.join(output_dir, "metrics", "resnet50_confusion_matrix.png")
...
if __name__ == "__main__":
    MODEL_PATH = r"D:\MODELS\ResNet\ResNetHQ2\20241208\final_model.pth"
    DATA_DIR = r"D:\FYPSeagullClassification01\Test_Results\Test_Data"
    OUTPUT_DIR = r"D:\FYPSeagullClassification01\Test_Results\Test_Results\resnet50_results"
